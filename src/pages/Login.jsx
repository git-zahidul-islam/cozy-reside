        ...
        <div className="flex justify-center items-center mt-5">
            ...
            <div className=" w-full max-w-md p-8 space-y-3 bg-gray-200">
                ...
                <button
                    ...
                    aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md  border-black "
                >
                ...
                <button
                    ...
                    aria-label="Login with GitHub" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md border-black"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
