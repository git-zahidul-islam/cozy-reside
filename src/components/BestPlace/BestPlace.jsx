    ...
    return (
        <div className="bg-[#F6F5F2] py-10 px-0 md:rounded-tl-[250px] rounded-tl-[150px] md:rounded-br-[250px] rounded-br-[150px] border-l-4 border-[#5755FE]">
            ...
            <div className="flex lg:flex-row md:flex-row flex-col justify-center items-center gap-5 mt-10">
                ...
                <div className="lg:w-2/12 md:w-2/12 w-5/12 h-full border-[5px] border-green-300"><img className="transition-all hover:scale-110 hover:rounded-lg" src={sliderImage2} alt="" /></div>
                <div className="lg:w-2/12 md:w-2/12 w-5/12 h-full border-[5px] border-green-300"><img className="transition-all hover:scale-110 hover:rounded-lg" src={sliderImage3} alt="" /></div>
            </div>
        </div>
    );
};
