...
const Footer = () => {
    ...
    return (
        <footer className="footer footer-center pt-10 bg-[#00afef5f] text-base-content rounded">
            ...
            <aside className="mt-3 bg-[#00afef83] w-full p-5 text-base">
                <p>Copyright © 2024 - All right reserved by Cozy Reside</p>
            </aside>
        </footer>
    );
};
